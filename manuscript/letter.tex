...
\renewcommand{\vector}[1]{\vec{\mathbf{#1}}}
...
$\gamma_{P} = \| \vector{\gamma}_{P} \|$, at the
...
\begin{equation}
\Delta \vector{g}_{P} = \vector{g}_{Q^{\prime}} - \vector{\gamma}_{Q} .
...
\end{equation}
where $g_{Q^{\prime} } = \| \vector{g}_{Q^{\prime}} \|$ is
the magnitude of the gravity vector $\vector{g}_{Q}$ on the Geoid,
at $Q^{\prime}$, and $\gamma_{Q} = \| \vector{\gamma}_{Q} \|$ is the
magnitude of the normal gravity vector $\vector{\gamma}_{Q}$
