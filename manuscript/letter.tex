...
Let $\mitbf{\gamma}_{P}$ and $\mitbf{g}_{P}$ and be, respectively,
...
The difference between $\mitbf{g}_{P}$ and $\mitbf{\gamma}_{P}$,
...
the gravity disturbance vector $\delta \mitbf{g}_{P}$
