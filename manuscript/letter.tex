...
Similarly, we can approximate the normal gravity $\gamma_{P}$
at a point $P$ on the Earth's surface
from the normal gravity at the ellipsoid $\gamma_{Q}$,
so that the gravity disturbance $\delta g_{P}$
...
the approximated gravity disturbance (eq. \ref{eq:gravity-disturbance-approx}),
at a point $P$ on or close to the Earth's surface,
and the Free-air anomaly (eq. \ref{eq:free-air-anomaly}) is:
